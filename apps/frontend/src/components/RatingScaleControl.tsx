...
/**
 * 10-star rating control for 0.00–10.00 in 0.25 increments.
 *
 * Stars: tap position within each star quantizes to nearest 0.25
 * (leftmost tap → +0.25, rightmost tap → +1.00).
 * Bumpers: ±0.25 buttons for precise mobile adjustment.
 * Value: live display using fmtScore (7.25 stays "7.25", not "7.3").
 */
